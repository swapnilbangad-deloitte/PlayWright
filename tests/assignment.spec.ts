...
// ---------------------------------------------------------------------------
test('Scenario 2: Drag & Drop Slider - move Default value 15 slider to 95', async ({ page }) => {
  const playground = new SeleniumPlaygroundPage(page);
...
// ---------------------------------------------------------------------------
test('Scenario 3: Input Form Submit - validation error then successful submission', async ({ page }) => {
  const playground = new SeleniumPlaygroundPage(page);
